...
/**
 * Sent when produce is harvested from a bush This can be used to identify both the bush that was harvested as well as
 * the produce
 */
public class ProduceCreated implements Event {
    private final EntityRef creator;
    private final EntityRef produce;
